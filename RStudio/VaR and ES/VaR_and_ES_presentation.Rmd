...
$\textrm{VaR}_\alpha(X) = \inf_l \{l : \mathbb{P}(X \geq l) \leq 1-\alpha \}$.
Additionally we define the *expected shortfall* 
$\textrm{ES}_\alpha(X) = \tfrac{1}{1-\alpha} \int_\alpha^1 \textrm{VaR}_u(X)\, \mathrm{d}u$. 
...
We track the two risk measures in Figure \ref{fig:var_and_es} for the Amazon (AMZN) equity,
